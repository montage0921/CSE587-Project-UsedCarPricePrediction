...
class Car_Info:
            ...
            async with async_playwright() as p: 
                    ...
                    while counter<=total_page:
                        try:
                            ...
                            counter+=1
                            await asyncio.sleep(0.5) # stop 1s after each click to be like a human being (x

                            if counter==total_page:
                                await page.wait_for_selector("hzn-button",timeout=50000) # wait the whole page finishes loading
                        except:
    ...
    async def scrape_car_info(self):
            ...
            for link in links:
                ...
                try:
                    async with async_playwright() as p:
                        ...
                        try:
                            await page.evaluate("window.scrollBy(0, 3200);") # use to solve lazy loading
